                  ...
                  new RaisedButton(
                    ...
                    shape:new RoundedRectangleBorder(
                      ...
                      child: new Row(
                        ...
                        children: <Widget>[
                          new Image.asset('assets/images/video.png',
                      ...
                      Padding(
                        ...
                        child: new RaisedButton(
                          ...
                          onPressed: (){
                            Navigator.of(context).pushReplacementNamed(IMAGE_SCREEN);
                          },
                          child: new Row(
                            mainAxisSize: MainAxisSize.min,
                            children: <Widget>[
                      ...
                      Padding(
                        ...
                        child: new RaisedButton(
                          ...
                          onPressed: () async{
                            Navigator.of(context).pushReplacementNamed(ANIMATED_SPLASH);
                          },
                          child: new Row(
                            mainAxisSize: MainAxisSize.min,
                            children: <Widget>[
